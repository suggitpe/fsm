...
class TransitionBuilder(var name: String, val type: TransitionKind) {
    ...
    companion object {
        ...
        fun aTransitionCalled(name: String): TransitionBuilder {
    ...
    var constraint: ConstraintBuilder = aConstraintCalled("EMPTY")
    ...
    fun guardedBy(constraint: ConstraintBuilder): TransitionBuilder {
        this.constraint = constraint
        return this
    }

    fun guardedBy(effect: (BusinessEvent) -> Boolean): TransitionBuilder {
        this.constraint = aConstraintCalled("ANONYMOUS").withGuardCondition(effect)
        return this
    }
