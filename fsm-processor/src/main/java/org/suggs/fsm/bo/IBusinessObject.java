...
/**
 * Top level interface for all business objects within the Scribe system. */
public interface IBusinessObject extends Cloneable {

    /**
     * Returns the current composite Id of the business object. */
    ...
    /**
     * The busines object's unique identifier that may be used as part of a primary key (compounded with version). */
    String getId();
